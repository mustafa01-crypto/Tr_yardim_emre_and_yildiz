...
class _YaziEkraniState extends State<YaziEkrani> {
  ...
  yaziEkle() {
    ...
    FirebaseFirestore.instance
        ...
        .set({'id':auth.currentUser.uid,'baslik': t1.text, 'icerik': t2.text,'tarih':t3.text,'adres':t4.text});
    t1.clear();
    t2.clear();
    t3.clear();
    t4.clear();
  ...
  yaziSil() {
    FirebaseFirestore.instance.collection("Yazilar").doc(auth.currentUser.email).delete();
    t1.clear();
  }
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: RaisedButton(
                        ...
                        color:Colors.blueGrey , child: Text("Ekle",style: TextStyle(color: Colors.white),
                        ),
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        ...
                        color:Colors.blueGrey , child: Text("Sil",style: TextStyle(color: Colors.white),
